 ...
 */
public class Chat2ListAdapter extends RecyclerView.Adapter<Chat2ListAdapter.ViewHolder> {
    ...
    public Chat2ListAdapter(Context context, ArrayList<clsChat> oChats){
        this.context = context;
    ...
    @Override
    public Chat2ListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_chat, parent, false);
        return new Chat2ListAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final Chat2ListAdapter.ViewHolder holder, final int position) {
    ...
    public void setUsuarioChats(JSONObject response){
